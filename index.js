...
const creatures = [
  (Rongeur = ["- Rongeur: ", "Discret 2, Vigilant 2, Esprit de meute 2"]),
  (Lievre_Renard = ["- Lievre ou Renard: ", "Rapide 3"]),
  (Rapace = ["- Rapace: ", "Vol 3 ,Bec acéré 2"]),
  (Chien_de_chasse = ["- Chien de chasse: ", "Morsure féroce 2, Rapide 2"]),
  (Chien_de_garde = [
    "- Chien de garde: ",
    "Excellente ouïe 2 ,Morsure féroce 2, Loyal 3",
  ]),
  (Loup = ["- Loup: ", "Esprit de meute 2, Morsure féroce 2, Odorat 2"]),
  (Glouton_Blaireau = [
    "- Glouton ou Blaireau: ",
    "Morsure féroce 3, Tenace 2",
  ]),
  (Chevreuil_Cheval = ["- Chevreuil ou Cheval: ", "Vigilant 2, Rapide 2"]),
  (Elan_Cerf = ["- Elan ou Cerf: ", "Gros 2, Ramure perforante 2"]),
  (Ours = ["- Ours: ", "Gros 2", "Morsure féroce 3, Griffes acérées 2"]),
  (Serrure_electronique = ["- Serrure electronique: ", "Mécanisme complexe 2"]),
  (Systeme_d_alarme = ["- Systeme d'alarme: ", "Capteurs perfectionnés 2"]),
  ...
  (Petit_dinosaure = ["- Petit dinosaure: ", "Rapide 2"]),
  (Velociraptor = [
    "- Velociraptor: ",
    "Bête féroce 3, Rapide comme l’éclair 3",
  ]),
  (Pterodactyle = ["- Pterodactyle: ", "Bête féroce 2, Vol 2"]),
  (Stegosaure_TRex = ["- Stegosaure ou T-Rex: ", "Bête féroce 3, Tenace 2"]),
  (Zombie = ["- Zombie: ", "Mort-vivant 2, Excellente ouïe 2"]),
  (Momie = ["- Momie: ", "Mort-vivant 3"]),
  (Fantome = ["- Fantome: ", "Invisible 2, Terrifiant 2"]),
  (Poltergeist = [
    "- Poltergeist: ",
    "Invisible 3, Terrifiant 2, Télékinésie 2",
  ]),
  (Plante_carnivore_geante = [
    "- Plante carnivore geante: ",
...
const generator = () => {
  ...
  const randomAntagonist = getRandomInt(
    antagonist[randomAntagonistCategory].length
  );
  const getRandomAntagonist =
    antagonist[randomAntagonistCategory][randomAntagonist];
  ...
  const randomBehaviour = getRandomInt(
    behaviour[randomBehaviourCategory].length
  );
  const getRandomBehaviour =
    behaviour[randomBehaviourCategory][randomBehaviour];
